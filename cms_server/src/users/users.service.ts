...
export class UsersService {
  ...
  async create(userData: UserData): Promise<User> {
    try {
      ...
      this.logger.error(
        `创建用户时发生错误 [${error instanceof Error ? error.constructor.name : typeof error}]: ${error instanceof Error ? error.message : String(error)}`,
  ...
  async findOne(email: string): Promise<User> {
    try {
      ...
      this.logger.error(
        `查询用户时发生错误 [${error instanceof Error ? error.constructor.name : typeof error}]: ${error instanceof Error ? error.message : String(error)}`,
        error instanceof Error ? error.stack : undefined,
      );
  ...
  async findOneById(id: string): Promise<User> {
    try {
      ...
      this.logger.error(
        `查询用户详情时发生错误 [${error instanceof Error ? error.constructor.name : typeof error}]: ${error instanceof Error ? error.message : String(error)}`,
        error instanceof Error ? error.stack : undefined,
      );
  ...
  async findAll(paginationDto: PaginationDto): Promise<UserListResponseDto> {
    try {
      ...
      this.logger.error(
        `获取用户列表时发生错误 [${error instanceof Error ? error.constructor.name : typeof error}]: ${error instanceof Error ? error.message : String(error)}`,
        error instanceof Error ? error.stack : undefined,
      );
  ...
  async update(id: string, updateData: UpdateData): Promise<User> {
    try {
      ...
      this.logger.error(
        `更新用户信息时发生错误 [${error instanceof Error ? error.constructor.name : typeof error}]: ${error instanceof Error ? error.message : String(error)}`,
        error instanceof Error ? error.stack : undefined,
      );
  ...
  async updateRole(id: string, role: string): Promise<User> {
    try {
      ...
      this.logger.error(
        `更新用户角色时发生错误 [${error instanceof Error ? error.constructor.name : typeof error}]: ${error instanceof Error ? error.message : String(error)}`,
        error instanceof Error ? error.stack : undefined,
      );
  ...
  async remove(id: string): Promise<null> {
    try {
      ...
      this.logger.error(
        `删除用户时发生错误 [${error instanceof Error ? error.constructor.name : typeof error}]: ${error instanceof Error ? error.message : String(error)}`,
        error instanceof Error ? error.stack : undefined,
      );
  ...
  async updateAvatar(id: string, avatarUrl: string): Promise<User> {
    try {
      ...
      this.logger.error(
        `更新用户头像时发生错误 [${error instanceof Error ? error.constructor.name : typeof error}]: ${error instanceof Error ? error.message : String(error)}`,
        error instanceof Error ? error.stack : undefined,
      );
